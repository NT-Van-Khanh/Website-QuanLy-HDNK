...
<body>
		...
		<div class="container-header">
			<div class="header-iteam">
				<div class="header-logo">
					<a href="nguoidang/dangdienra">ACTIVITY</a>
				</div>
				<div class="header-actions">
					<a href="" class="btntb"><i class="fas fa-bell"></i></a>
					<a href="nguoidang/dangdienra" class="btntk"><i class="fa fa-user"></i></a>
				</div>
			</div>
		</div>
	</header>
	<div class="container-body">
		<div class="sider">
			<div id="menu">
				<ul>
					<li><a href="nguoidang/dangdienra" class="dangdienra"><i
					...
					<li><a href="nguoidang/damgbai.htm" class="dangbai"><i
