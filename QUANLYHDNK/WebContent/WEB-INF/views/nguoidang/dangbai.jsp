...
<head>
	...
	<link href="<c:url value="/resources/css/db.css" />" rel="stylesheet">
...
<body>
    ...
    <div class="container-body">
		...
		<div class="main-content">
			<form action="nguoidang/dangbai.htm" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label for="title">Tiêu đề:</label>
					<input type="text" id="title" name="name-activity" placeholder="Nhập tiêu đề hoạt động" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="datetime-local" id="time" name="start-time" required>
				</div>
				<div class="form-group">
					<label for="time">Kết thúc đăng ký:</label>
					<input type="datetime-local" id="time" name="end-time"required>
				</div>
				<div class="form-group">
					<label for="content">Nội dung:</label>
					<textarea id="content" name="content-activity" placeholder="Nội dung hoạt động" required></textarea>
				</div>

				<div class="form-group">
					<label for="slots">Số lượng:</label>
					<input type="text" id="slots" name="quantity" placeholder="Số lượng tham gia (VD: 100/100)" required>
				</div>
