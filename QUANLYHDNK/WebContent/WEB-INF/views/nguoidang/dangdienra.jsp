...
<title>Bài đang đăng</title>
<link href="<c:url value="/resources/css/dangdienra.css" />"
	rel="stylesheet">
		...
		<div class="container-header">
			<div class="header-iteam">
				...
				<div class="header-actions">
					<a href="" class="btntk"><i class="fas fa-bell"></i></a>
					<a href="nguoidang/account.htm" class="btntk"><i class="fa fa-user"></i></a>
				</div>
			</div>
		</div>
	</header>
					...
					<div class="dshoatdong" data-title-id="${a.title.getIdTitle()}">
						<div class="tthoatdong">
							<div class="hoatdong">
								...
								<div class="chinhsua">
									<form action="<c:url value='/nguoidang/edit-activity.htm'/>" method="POST">
										<input type="hidden" name="id" value="${a.idActivity}">
										...
										<button type="submit" class="btnchinhsua ignore-click" >Chỉnh sửa</button>
									</form>
								</div>
							</div>
							<div class="chitiet">
								<div class="p1">
									...
									<div class="theloai"><b>Thể loại:</b> ${a.title.getNameTitle()}  <b>  Mã hoạt động:  </b> ${a.idActivity}</div>
								...
								<div class="p2">
									...
									<div class="timepost"><b>Mã hoạt động:</b> ${a.idActivity}</div>
								</div>
							</div>
						</div>
					</div>
